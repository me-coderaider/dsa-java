package divide_and_conquer.convert_one_string_to_another;

public class ConvertOneStringToAnother {

	private int findMinOperations(String s1, String s2, int i1, int i2) {

		// if string 's1' is completely visited then we'll
		// adding all remaining characters to S1
		if (i1 == s1.length()) {
			return s2.length() - i2;
		}
