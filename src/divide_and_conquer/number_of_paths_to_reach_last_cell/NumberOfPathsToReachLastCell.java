package divide_and_conquer.number_of_paths_to_reach_last_cell;
...
public class NumberOfPathsToReachLastCell {
	public int numberOfPaths(int[][] array, int row, int col, int cost) {
		...
		int noOfPathsFromPreviousRow = numberOfPaths(array, row - 1, col, cost - array[row][col]); // moving up
		int noOfPathsFromPreviousCol = numberOfPaths(array, row, col - 1, cost - array[row][col]); // moving left
